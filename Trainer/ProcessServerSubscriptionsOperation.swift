...
class ProcessServerSubscriptionsOperation: Operation {
    ...
    fileprivate func setSubscriptionsToCreate() {
        ...
        let missingSubscriptionZoneNames = expectedZoneNamesWithSubscriptionsSet.subtracting(serverSubscriptionZoneNamesSet)
    ...
    fileprivate func setSubscriptionsToDelete() {
        
        let serverSubscriptionZoneNamesSet = createServerSubscriptionZoneNameSet()
        let expectedZoneNamesWithSubscriptionsSet = Set(CloudKitZone.allCloudKitZoneNames)
        let unexpectedSubscriptionZoneNamesSet = serverSubscriptionZoneNamesSet.subtracting(expectedZoneNamesWithSubscriptionsSet)
    ...
    fileprivate func createServerSubscriptionZoneNameSet() -> Set<String> {
